...
Most of these come down to network reality or how imo-shortlist serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

imo-shortlist rate-limits like any public site. imo-shortlist already paces
...
Where a surface is gated, imo-shortlist reads a cookie or token you supply
...
`imo-shortlist`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what imo-shortlist actually did
