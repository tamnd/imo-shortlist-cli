...
```
imo-shortlist <command> [arguments] [flags]
```

Run `imo-shortlist <command> --help` for the full flag list on any command. This
...
per operation you declare in `imo-shortlist/domain.go`.
